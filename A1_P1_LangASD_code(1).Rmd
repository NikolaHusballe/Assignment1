...
demo_train = plyr::rename(demo_train, c("Child.ID"="SUBJ", "Visit"="VISIT", "MullenRaw" = "nonverbalIQ", "ExpressiveLangRaw"="verbalIQ"))
...
token_train$VISIT = str_extract(LU_train$VISIT,"\\d" )
...
library(tidyverse)
data1 = select(demo_train, SUBJ, VISIT, Ethnicity, Diagnosis, Gender, Age, ADOS, nonverbalIQ, verbalIQ)
...
DATA$SUBJ = as.numeric(DATA$SUBJ, levels = 61)

DATA$Gender = as.factor(DATA$Gender)
DATA$Gender = plyr::revalue(DATA$Gender, c("1"="M", "2"="F"))
